...
## 🎯 Expertise
<div align="center">
  <img src="https://img.shields.io/badge/Unity-000000?style=for-the-badge&logo=unity&logoColor=white&logoWidth=28"/>
  ...
  <table style="width: 100%; max-width: 1200px; margin: 0 auto; table-layout: fixed;">
    <tr>
      ...
      <td valign="middle" style="word-wrap: break-word; overflow: hidden;">
        ...
        <strong>여러 게임 서버 아키텍처 구성 및 자가 호스팅 환경 세팅</strong><br>
  ...
  <table style="width: 100%; max-width: 1200px; margin: 0 auto; table-layout: fixed;">
    <tr>
      ...
      <td valign="middle" style="word-wrap: break-word; overflow: hidden;">
        ...
        <strong>수집 데이터로 LDA, Word2Vec, WordNet, WordCloud를 활용한 자연어 처리(NLP) 자동 분석 파이프라인 구축</strong><br>

...
- 수집 데이터를 LDA, Word2Vec, WordNet, WordCloud로 자동 분석
- 사회적 이슈 반응 감정 분석 및 키워드 시각화 파이프라인 구축
